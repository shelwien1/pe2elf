...
// from shim32.cpp.  Must come before shim32_kernel32_file_a.hpp since the
// A-variants reuse `find_ctx_open`, `fill_find_data_a`, `win_fnmatch`,
// and `stat_to_win_attrs` defined here.
//
// References from shim32.cpp: handle_alloc_file, handle_alloc_find,
...
// Defined in shim32_kernel32_sync.hpp (included below); forward-declared here
