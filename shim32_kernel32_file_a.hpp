#pragma once
// A-variant file/directory functions — included from shim32.cpp.
//
...
// already in shim32.cpp.  CreateFileA also handles the Windows console
// device aliases (CON/CONIN$/CONOUT$).
//
// References from shim32.cpp: FindCtx, find_ctx_open, fill_find_data_a,
