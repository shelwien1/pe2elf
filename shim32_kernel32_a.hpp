...
// kernel32 entries — included from shim32.cpp.
//
// Most of these are thin char* → wchar* conversions that delegate to the
// W-variant defined in shim32.cpp, plus tiny stubs (GetDriveTypeA,
// GetDiskFreeSpace, GetVersionEx, RtlFillMemory, RtlCompareMemory) that
// don't fit anywhere else.
//
// References from shim32.cpp: win_path_to_posix, utf8_to_wchar,
