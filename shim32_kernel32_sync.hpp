#pragma once
// kernel32 threading/sync shims — included from shim32.cpp.
...
// Thread
// ---------------------------------------------------------------------------
typedef uint32_t (__attribute__((stdcall)) *win_thread_fn)(void*);
...
extern void shim_init_teb(void);         // defined in shim32.cpp
extern void run_tls_callbacks(uint32_t); // defined in shim32.cpp
extern void tls_static_init_thread(void);// defined in shim32.cpp
