...
// =============================================================================
sqword UpdateModel(byte* a1, uint a2) {
  PPM_CONTEXT* ctx   = (PPM_CONTEXT*)a1;
  uint         Order = a2;
  ...
  if( v0!=v14 ) {
    ...
    while( 1 ) {
      ...
      if( *v5 ) {
        ...
        v56 = (uint*)(v120+12LL*Units2Indx4[0]);
        if( *v56 ) {
          v57 = v10+(uint)v56[1];
          v56[1] = *(uint*)(v57+4);
